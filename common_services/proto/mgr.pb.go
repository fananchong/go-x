...
func (x CMD_MGR) String() string {
	return proto1.EnumName(CMD_MGR_name, int32(x))
}
...
func (m *SERVER_INFO) String() string            { return proto1.CompactTextString(m) }
func (*SERVER_INFO) ProtoMessage()               {}
func (*SERVER_INFO) Descriptor() ([]byte, []int) { return fileDescriptorMgr, []int{0} }

func (m *SERVER_INFO) GetId() uint32 {
	if m != nil {
		return m.Id
	}
	return 0
...
func (m *MSG_MGR_REGISTER_SERVER) String() string            { return proto1.CompactTextString(m) }
...
func (m *MSG_MGR_LOSE_SERVER) String() string            { return proto1.CompactTextString(m) }
func (*MSG_MGR_LOSE_SERVER) ProtoMessage()               {}
func (*MSG_MGR_LOSE_SERVER) Descriptor() ([]byte, []int) { return fileDescriptorMgr, []int{2} }

func (m *MSG_MGR_LOSE_SERVER) GetId() uint32 {
	if m != nil {
		return m.Id
	}
	return 0
...
func init() {
	proto1.RegisterType((*SERVER_INFO)(nil), "proto.SERVER_INFO")
	proto1.RegisterType((*MSG_MGR_REGISTER_SERVER)(nil), "proto.MSG_MGR_REGISTER_SERVER")
	proto1.RegisterType((*MSG_MGR_LOSE_SERVER)(nil), "proto.MSG_MGR_LOSE_SERVER")
	proto1.RegisterEnum("proto.CMD_MGR", CMD_MGR_name, CMD_MGR_value)
}
...
func (m *SERVER_INFO) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Id != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintMgr(dAtA, i, uint64(m.Id))
	}
	if len(m.Addrs) > 0 {
	...
	if len(m.Ports) > 0 {
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintMgr(dAtA, i, uint64(j1))
		i += copy(dAtA[i:], dAtA2[:j1])
	}
	if len(m.Overload) > 0 {
		dAtA4 := make([]byte, len(m.Overload)*10)
		var j3 int
		...
		dAtA[i] = 0x22
		i++
		i = encodeVarintMgr(dAtA, i, uint64(j3))
...
func init() { proto1.RegisterFile("mgr.proto", fileDescriptorMgr) }

var fileDescriptorMgr = []byte{
	// 260 bytes of a gzipped FileDescriptorProto
	,
}

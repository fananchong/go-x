...
require (
	...
	github.com/fananchong/gotcp v0.0.0-20181210144519-451af8cfa968
	github.com/fananchong/multiconfig v0.0.0-20180107083632-8e910cce6043
	...
	github.com/mna/redisc v1.1.3 // indirect
